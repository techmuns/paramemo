...
async function handleGenerate(request, env, ctx) {
  ...
  const system =
    ...
    '• USE THE RICHEST LABELLED SERIES: if the IM has a financial-summary page whose year headers carry explicit A / E / P suffixes (e.g. "FY22A FY23A FY24A FY25A FY26E FY27P"), THAT page is the authority for the year span AND the actual-vs-forecast split — it is usually richer than a single Excel tab. Include EVERY historical ACTUAL year it shows; do NOT drop earlier actual years (FY22A, FY23A …) just because the Excel tab you take row detail from starts later. Take the full labelled span from that page and fill row depth from the Excel where the years overlap.\n' +
